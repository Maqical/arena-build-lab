...
export function Settings() {
  ...
  return <main className="settings-shell">
    ...
    <section className="settings-card"><div className="settings-about-heading"><h2>Updates & about</h2><span className="settings-version">v1.0.1</span></div><p>Arena Build Lab runs locally and reads the supported local client surfaces without game injection.</p><button type="button" onClick={() => void window.arenaDesktop?.checkForUpdates()}>Check for updates</button></section>
  </main>;
}
