...
export type LobbyMemberAnalysis = { puuid: string; gameName: string; tagLine: string; rank?: string; games: number; firstPlaceRate: number | null; averagePlacement: number | null; mostPlayed: Array<{ championName: string; games: number }> };

export function analyzeLobbyMembers(members: Array<{ puuid: string; gameName: string; tagLine: string; rank?: string }>): LobbyMemberAnalysis[] {
